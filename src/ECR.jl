...
function get_login(registry_id::AbstractString=""; config::AWSConfig=default_aws_config())
...
function get_login(registry_id::Integer; config::AWSConfig=default_aws_config())
